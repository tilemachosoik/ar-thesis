...
def check_magnum_plugins(conf, *k, **kw):
    ...
    for component in requested_components:
        ...
        if component == 'AssimpImporter':
            ...
            try:
                assimp_inc = get_directory('assimp/anim.h', set(includes_check + global_includes_check))
                ...
                lib_dir = get_directory('libassimp.'+suffix, set(libs_check + global_libs_check))
                magnum_plugins_libpaths = magnum_plugins_libpaths + [lib_dir]
            ...
            try:
                freetype_inc = get_directory('freetype/ft2build.h', set(includes_check + global_includes_check), True)
                ...
                lib_dir = get_directory('libfreetype.'+suffix, set(libs_check + global_libs_check))
                magnum_plugins_libpaths = magnum_plugins_libpaths + [lib_dir]
            ...
            try:
                jpeg_inc = get_directory('jpeglib.h', set(includes_check + global_includes_check))
                ...
                lib_dir = get_directory('libjpeg.'+suffix, set(libs_check + global_libs_check))
                magnum_plugins_libpaths = magnum_plugins_libpaths + [lib_dir]
            ...
            try:
                png_inc = get_directory('png.h', set(includes_check + global_includes_check))
                ...
                lib_dir = get_directory('libpng.'+suffix, set(libs_check + global_libs_check))
                magnum_plugins_libpaths = magnum_plugins_libpaths + [lib_dir]
